...
// +kubebuilder:webhook:path=/mutate-theketch-io-v1-framework,mutating=true,failurePolicy=fail,groups=theketch.io,resources=frameworks,verbs=create;update,versions=v1beta1,name=mframework.kb.io,sideEffects=none,admissionReviewVersions="v1beta1"
...
// +kubebuilder:webhook:verbs=create;update;delete,path=/validate-theketch-io-v1-framework,mutating=false,failurePolicy=fail,groups=theketch.io,resources=frameworks,versions=v1beta1,name=vframework.kb.io,sideEffects=none,admissionReviewVersions="v1beta1"
